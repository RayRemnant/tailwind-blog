...
You will see the list of disks connected to your device. On the left you can see `Disk 0`, `Disk 1` etc.

Find your desired disk and use the number in the following command:
