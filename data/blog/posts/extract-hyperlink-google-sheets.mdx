...
Courtesy of (https://stackoverflow.com/a/67206954)[https://stackoverflow.com/a/67206954]
...
Once you've filled all the necessary cells, select your column and press CTRL + H, this will open up the Find and replace window (if the shortcut does not work, go to Edit > Find and replace - should be the last option).
...
Your links should now appear in the new created column.

You can copy the column, select your previous column and Right Click > Paste Special > Values Only.

The new column will not have an hyperlink associated with them though.
...
After that, click the Run button on the upper menu, you should see the changes on your sheet. Remember that this will work on your active sheet.
